                      ...
                      <table class="datatables-customers table border-top" id="users_list">
                        ...
                        <tbody class="table-border-bottom-0">
                          ...
                          <tr> 
                              ...
                              <td><span class="fw-medium">{{ $users->fullname }}</span></td>
                              <td><span class="fw-medium">{{ $users->gender }}</span></td>
                              <td>{{ $users->email }}</td>
                              <td>{{ $users->staff_type }}</td>
                              <td>{{ \Carbon\Carbon::parse($users->added_date)->format('d-m-Y') }}</td>
                              <td>
